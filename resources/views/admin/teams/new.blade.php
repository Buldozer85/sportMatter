<x-admin::layouts.dashboard title="Vytvoření teamu">
    <form action="{{ route('admin.teams.create') }}" method="post">
        @csrf
        <h1 class="text-center font-bold text-xl">Vytvoření týmu</h1>
