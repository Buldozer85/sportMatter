        ...
        <div class="flex flex-col mb-4 mt-5" x-data="{
            ...
            <div>
                <div x-show="selectedSport == 1">   {{--         TODO: Jestli neudělat kontrolu spíš podle nějakého klíče idk           --}}
                    ...
                    <x-admin.forms.input id="count_of_legs_first_player" name="count_of_legs_first_player"/> {{--        TODO: same pro druhého hráče, ještě i sety           --}}
                    <x-admin.forms.input id="avarage_player_one" name="avarage_player_one"></x-admin.forms.input> {{--        TODO: same pro druhého hráče          --}}
                </div>
