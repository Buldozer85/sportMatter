    ...
    <form method="post">
        ...
        <div class="flex flex-col mb-4 mt-5" x-data="{
            ...
            <div x-data="{refereeCount: 1 }">
                <div class="flex flex-row gap-5"
                     x-init="$watch('refereeCount', value => { if(value < 2) $refs.removeBtn.style.display = 'none'; else $refs.removeBtn.style.display = 'inline-block'; })">
                ...
                <button type="button" class="w-fit h-fit px-3 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @click="$refs.teamContainer.removeChild($refs.teamContainer.lastElementChild); refereeCount--" x-ref="removeBtn" style="display: none">
            ...
            <div>
                <div x-show="selectedSport == 1">
                    ...
                    <div class="flex flex-row gap-5">
                        ...
                        <div class="w-6/12">
                            <x-admin.forms.input id="avarage_player_one" name="avarage_player_one"
