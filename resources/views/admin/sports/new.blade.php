<x-admin::layouts.dashboard title="Vytvoření sportu">
    <form action="{{ route('admin.sports.create') }}" method="post">
        @csrf
        <h1 class="text-center font-bold text-xl">Vytvoření sportu</h1>
