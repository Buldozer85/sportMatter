<x-admin::layouts.dashboard title="Vytvoření státu">
    <form action="{{ route('admin.countries.create') }}" method="post">
        @csrf
        <h1 class="text-center font-bold text-xl">Vytvoření státu</h1>
