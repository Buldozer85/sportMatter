    ...
    public function rules(): array
    {
        ...
        switch ($sportName) {
            case "Fotbal":
                ...
                $rules['number_of_offsides_home_team'] = ['nullable', 'integer'];
                $rules['number_of_fouls_home_team'] = ['nullable', 'integer'];
                ...
                $rules['number_of_offsides_away_team'] = ['nullable', 'integer'];
                $rules['number_of_fouls_away_team'] = ['nullable', 'integer'];
                $rules['number_of_red_cards_away_team'] = ['nullable', 'integer'];
                $rules['number_of_yellow_cards_away_team'] = ['nullable', 'integer'];
                ...
                break;
            case "Hokej":
                $rules['hockey_count_of_goals_home_team'] = ['nullable', 'integer'];
                $rules['hockey_shooting_success_home_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_shots_on_goal_home_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_shots_home_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_exclusion_home_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_goalkeeper_interventions_home_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_blocked_shots_home_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_power_play_goals_home_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_buly_won_home_team'] = ['nullable', 'integer'];
                $rules['hockey_count_of_goals_away_team'] = ['nullable', 'integer'];
                $rules['holding_the_ball_away_team'] = ['nullable', 'integer'];
                $rules['hockey_shooting_success_away_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_shots_on_goal_away_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_shots_away_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_exclusion_away_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_goalkeeper_interventions_away_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_blocked_shots_away_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_buly_won_away_team'] = ['nullable', 'integer'];
                $rules['hockey_number_of_power_play_goals_away_team'] = ['nullable', 'integer'];
                ...
                break;
            case "Šipky":
                $rules['count_of_sets_first_player'] = ['nullable', 'integer'];
                $rules['count_of_legs_first_player'] = ['nullable', 'integer'];
                $rules['average_first_player'] = ['nullable'];
                $rules['count_of_sets_second_player'] = ['nullable', 'integer'];
                $rules['count_of_legs_second_player'] = ['nullable', 'integer'];
                $rules['average_player_two'] = ['nullable'];
